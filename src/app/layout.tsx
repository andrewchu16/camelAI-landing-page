...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "camelAI: The AI Data Analyst. Ask questions, get instant charts and insights from your data.",
    description: "Transform your data analysis with camelAI. Ask questions in plain English and get instant insights from your database. No SQL needed.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "camelAI",
              "description": "AI-powered data analysis tool that converts natural language questions into database insights",
      ...
      <body className="font-['Segoe_UI'] antialiased">
        {children}
      </body>
    </html>
  );
