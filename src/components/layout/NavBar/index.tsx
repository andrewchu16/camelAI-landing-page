...
export const NavBar = () => {
  return (
    <nav className="bg-black/10 backdrop-blur-[10px] font-semibold text-small flex justify-center py-2.5 w-full rounded-lg transition-all duration-700 ease-in-out">
